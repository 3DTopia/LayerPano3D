...
from utils.lama.saicinpainting.training.losses.distance_weighting import make_mask_distance_weighter
from utils.lama.saicinpainting.training.losses.feature_matching import feature_matching_loss, masked_l1_loss
# from annotator.lama.saicinpainting.training.modules.fake_fakes import FakeFakesGenerator
from utils.lama.saicinpainting.training.trainers.base import BaseInpaintingTrainingModule, make_multiscale_noise
from utils.lama.saicinpainting.utils import add_prefix_to_keys, get_ramp
